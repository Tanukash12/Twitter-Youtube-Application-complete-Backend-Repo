...
const getUserProfile = asyncHandler(async(req, res) => {
    ...
    console.log(channel) //array of users -> our case only 1
        ...
        },
        {
            $lookup: {
                ...
                pipeline: [
                    ...
                    // array ayega return ho kr to hme uski first value leni hai frontent workload kam krne k liye anaother pipeline
                    {
                        $addFields: {
                            owner: {
                                $first: "$owner"
